...
-- Add line under to end of current line
vim.keymap.set("n", "J", "mzJ`z")
-- Keep cursor at center of screen with C-d and C-u
vim.keymap.set("n", "<C-d>", "<C-d>zz")
vim.keymap.set("n", "<C-u>", "<C-u>zz")
-- Keep search term in middle of screen when iterating
vim.keymap.set("n", "n", "nzzzv")
vim.keymap.set("n", "N", "Nzzzv")

-- greatest remap ever, keep paste buffer when pasting
